...
def pad_sequences(data, max_length):
    ...
    for sentence, labels in data:
        ...
        if len(sentence) >= max_length:
            ...
            ret.append((sentence + [zero_vector]*num_padding, labels + [zero_label]*num_padding, [True]*len(sentence)+[False]*num_padding))
        ### END YOUR CODE ###
    return ret
...
class RNNModel(NERModel):
    ...
    def add_prediction_op(self):
        ...
        b_2 = tf.get_variable('b2', (Config.n_classes))
    ...
    def add_loss_op(self, preds):
        ...
        loss = tf.reduce_sum(tf.nn.sparse_softmax_cross_entropy_with_logits(logits=masked_preds, labels=masked_labels))
        ### END YOUR CODE
        return loss
